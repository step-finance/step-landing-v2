  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      <div className="pointer-events-none absolute inset-0 opacity-40">
        <div className="absolute left-[-10%] top-[-5%] h-72 w-72 rounded-full bg-cyan/14 blur-3xl" />
        <div className="absolute right-[-6%] top-[12%] h-80 w-80 rounded-full bg-accent/8 blur-3xl" />
        <div className="absolute bottom-0 left-[28%] h-72 w-72 rounded-full bg-orange/8 blur-3xl" />
      </div>
      <SiteHeader
